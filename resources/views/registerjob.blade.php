    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Register Job</div>
                <div class="panel-body">
                    <form class="form-horizontal" id="form" role="form" method="POST" action="{{ route('registerjob.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="state" type="text" class="form-control" name="state" value="{{ old('city') }}" required>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#form').submit(function(){
            alert("User job successfully added!");
         });
    });
</script>
@endsection